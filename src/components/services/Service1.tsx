    ...
    <div className="font-sans text-gray-900 bg-white overflow-x-hidden selection:bg-pink-500 selection:text-white">
     ...
     <section className="py-8 sm:py-12 lg:py-16 bg-white">
        ...
        <div className={GRID_CONTAINER}>
          <div className="flex flex-col xl:flex-row gap-16 items-center">
            ...
            <div className="w-full xl:w-1/2 lg:pl-12">
              <h2 className="text-4xl sm:text-6xl font-black text-black mb-8 uppercase tracking-tighter">Lorem ipsum<br/>dolor sit.</h2>
              <p className="text-gray-600 mb-10 max-w-lg">Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent.</p>
      ...
      <section className="bg-white py-12 lg:py-16">
            ...
            <div className="bg-[#EBEBEB] flex flex-col lg:flex-row overflow-hidden rounded-sm">
              ...
              <div className="w-full lg:w-1/3 p-8 sm:p-10 lg:p-12 flex flex-col gap-6 justify-center">
                <div className="bg-white p-8 rounded-sm shadow-sm flex flex-col items-center text-center">
                  ...
                  <h4 className="font-bold text-black mb-3 uppercase tracking-tight">Inceptos himenaeos</h4>
                ...
                <div className="bg-white p-8 rounded-sm shadow-sm flex flex-col items-center text-center">
                  ...
                  <h4 className="font-bold text-black mb-3 uppercase tracking-tight">Class aptent taciti</h4>
                  <p className="text-xs text-gray-600 leading-relaxed">
        ...
        <section className="w-full bg-[#FAFAFA] pt-20 lg:pt-28 pb-10 relative overflow-hidden font-sans">
          <div className={GRID_CONTAINER}>
